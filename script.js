...
class App {
    ...
    constructor() {
        // Get user's position and load the map
        this._getPosition();
    ...
    _hideForm() {
        ...
        setTimeout(() => (form.style.display = 'grid'), 1000); // Brief timeout to hide and show form properly
    }
    ...
    _renderWorkoutMarker(workout) {
        L.marker(workout.coords).addTo(this.#map)
            ...
            .setPopupContent(`${workout.type === 'running' ? '🏃‍♂️ Running' : '🚴‍♀️ Cycling'} - ${workout.description}`)
            .openPopup();
    }
